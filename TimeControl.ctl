...
'**********************************************
'*         Open Source TimeControl            *
'*            by Jonne Lehtinen               *
'*                                            *
'* Date: 5.2.2003                             *
'* Eclipser@vorlonempire.com                  *
'* http://tassumusic.cjb.net                  *
'*                                            *
'* I made this control because I needed       *
'* more "flexible" time control box than the  *
'* dtpicker one for my commercial application.*
'*                                            *
'**********************************************
